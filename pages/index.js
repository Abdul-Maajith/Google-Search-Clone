  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <header className="flex w-full p-4 justify-between text-sm text-gray-700">
        ...
        {/* Avatar */}
        <Avatar url="https://socialfiremedia.com/wp-content/uploads/2016/01/Matt-Davidson-Social-Fire-Media.png" />
        ...
        <form className="flex flex-col items-center mt-40 flex-grow w-4/5">
          ...
          <div className="flex flex-col w-1/2 space-y-2 justify-center m-6 sm:space-y-0 sm:space-x-4 sm:flex-row">
